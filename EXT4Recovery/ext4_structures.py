...
class Superblock:
    ...
    def has_journal(self) -> bool:
        """Check if filesystem has journal feature"""
        # Feature compat flag for HAS_JOURNAL is 0x4
        return (self.s_feature_compat & 0x4) != 0
...
EXT4_GROUP_DESC_SIZE = 64  # Standard size (32 bytes for 32-bit, 64 for 64-bit)
